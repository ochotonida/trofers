...
public class CommonConfig {
    ...
    public final Supplier<Double> trophyChance = () -> 0.5;
    public final Supplier<Boolean> enableTrophyLoot = () -> true;
    public final Supplier<Boolean> enableTrophyEffects = () -> true;
