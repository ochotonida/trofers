...
public class VanillaLootTables extends LootTableBuilder {
    ...
    protected void addLootTables() {
        ...
        add(EntityType.FOX, 1, 3, Items.SWEET_BERRIES);
        ...
        add(EntityType.STRAY, 2, 8, entry(Items.TIPPED_ARROW).apply(SetNBT.setTag(Util.make(new CompoundNBT(), (tag) -> tag.putString("Potion", "minecraft:slowness")))));
