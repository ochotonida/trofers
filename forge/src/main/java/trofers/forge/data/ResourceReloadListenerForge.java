...
public class ResourceReloadListenerForge extends SimpleJsonResourceReloadListener {

    private final ResourceLoader<?> loader;

    public ResourceReloadListenerForge(ResourceLoader<?> loader) {
